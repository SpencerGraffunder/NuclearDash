HaltechDashValue dashValues[] = {
    ...
    {"Trigger Sync Level",           "TrigSyncLv", HT_TRIGGER_SYNC_LEVEL,     0x369,  6,       7,     UNIT_RAW,       1.0f,   0.0f,    20,   false,  0,    0.0f},
    ...
    {"Brake Pressure Front",         "BrakePresF", HT_BRAKE_PRESSURE_FRONT,   0x36B,  0,       1,     UNIT_KPA,       1.0f,   -101.3f, 20,   false,  0,    0.0f},
    ...
    {"Launch Control Ign Retard",    "LCIgRetard", HT_LC_IGN_RETARD,          0x36E,  2,       3,     UNIT_DEGREES,   0.1f,   0.0f,    20,   true,   0,    0.0f},
    ...
    {"Generic Output 1 Duty Cycle",  "GenOut1DC",  HT_GENERIC_OUTPUT_1_DUTY,  0x36F,  0,       1,     UNIT_PERCENT,   0.1f,   0.0f,    20,   false,  0,    0.0f},
    {"Boost Control Output",         "BoostCtl",   HT_BOOST_CONTROL_OUTPUT,   0x36F,  2,       3,     UNIT_PERCENT,   0.1f,   0.0f,    20,   false,  0,    0.0f},
    ...
    {"Fuel Flow Return",             "FuelFloRet", HT_FUEL_FLOW_RETURN,       0x371,  2,       3,     UNIT_CCPM,      1.0f,   0.0f,    10,   false,  0,    0.0f},
    {"Battery Voltage",              "BattVolt",   HT_BATTERY_VOLTAGE,        0x372,  0,       1,     UNIT_VOLTS,     0.1f,   0.0f,    10,   false,  0,    0.0f},
    {"Target Boost Level",           "BoostTar",   HT_TARGET_BOOST_LEVEL,     0x372,  4,       5,     UNIT_KPA,       0.1f,   0.0f,    10,   false,  0,    0.0f},
    ...
    {"Ambient Air Temperature",      "AmbTemp",    HT_AMBIENT_AIR_TEMP,       0x376,  0,       1,     UNIT_K,   0.1f,   0.0f,    10,   false,  0,    0.0f},
    {"Relative Humidity",            "RelHumid",   HT_RELATIVE_HUMIDITY,      0x376,  2,       3,     UNIT_PERCENT,   0.1f,   0.0f,    10,   true,   0,    0.0f},
    {"Specific Humidity",            "SpeHumid",   HT_SPECIFIC_HUMIDITY,      0x376,  4,       5,     UNIT_PPM,       100.0f, 0.0f,    10,   false,  0,    0.0f},
    {"Absolute Humidity",            "AbsHumid",   HT_ABSOLUTE_HUMIDITY,      0x376,  6,       7,     UNIT_GPM3,      0.1f,   0.0f,    10,   false,  0,    0.0f},
    {"Coolant Temperature",          "CoolantTmp", HT_COOLANT_TEMPERATURE,    0x3E0,  0,       1,     UNIT_K,   0.1f,   0.0f,    5,    false,  0,    0.0f},
    {"Air Temperature",              "AirTemp",    HT_AIR_TEMPERATURE,        0x3E0,  2,       3,     UNIT_K,   0.1f,   0.0f,    5,    false,  0,    0.0f},
    {"Fuel Temperature",             "FuelTemp",   HT_FUEL_TEMPERATURE,       0x3E0,  4,       5,     UNIT_K,   0.1f,   0.0f,    5,    false,  0,    0.0f},
    {"Oil Temperature",              "OilTemp",    HT_OIL_TEMPERATURE,        0x3E0,  6,       7,     UNIT_K,   0.1f,   0.0f,    5,    false,  0,    0.0f},
    {"Gearbox Oil Temperature",      "GearOilTmp", HT_GEARBOX_OIL_TEMP,       0x3E1,  0,       1,     UNIT_K,   0.1f,   0.0f,    5,    false,  0,    0.0f},
    {"Diff Oil Temperature",         "DiffOilTmp", HT_DIFF_OIL_TEMPERATURE,   0x3E1,  2,       3,     UNIT_K,   0.1f,   0.0f,    5,    false,  0,    0.0f},
    ...
    {"Fuel Trim Short Term Bank 1",  "FuelTrmST1", HT_FUEL_TRIM_SHORT_TERM_1, 0x3E3,  0,       1,     UNIT_PERCENT,   0.1f,   0.0f,    5,    true,   0,    0.0f},
    {"Fuel Trim Short Term Bank 2",  "FuelTrmST2", HT_FUEL_TRIM_SHORT_TERM_2, 0x3E3,  2,       3,     UNIT_PERCENT,   0.1f,   0.0f,    5,    true,   0,    0.0f},
    {"Fuel Trim Long Term Bank 1",   "FuelTrmLT1", HT_FUEL_TRIM_LONG_TERM_1,  0x3E3,  4,       5,     UNIT_PERCENT,   0.1f,   0.0f,    5,    true,   0,    0.0f},
    {"Fuel Trim Long Term Bank 2",   "FuelTrmLT2", HT_FUEL_TRIM_LONG_TERM_2,  0x3E3,  6,       7,     UNIT_PERCENT,   0.1f,   0.0f,    5,    true,   0,    0.0f},
    {"TM Knob",                      "TqMgmtKnob", HT_TORQUE_MGMT_KNOB,       0x3E9,  7,       7,     UNIT_RAW,       1.0f,   0.0f,    20,   true,   0,    0.0f},
    {"Gearbox Line Pressure",        "GearLinePr", HT_GEARBOX_LINE_PRESSURE,  0x3EA,  0,       1,     UNIT_KPA,       0.1f,   -101.3f, 50,   false,  0,    0.0f},
    ...
    {"TM Drive RPM Target",          "TMRPMTar",   HT_TM_RPM_TARGET,          0x3EC,  0,       1,     UNIT_RPM,       1.0f,   0.0f,    50,   true,   0,    0.0f},
    {"TM Drive RPM Target Error",    "TMRPMError", HT_TM_RPM_ERROR,           0x3EC,  2,       3,     UNIT_RPM,       1.0f,   0.0f,    50,   true,   0,    0.0f},
    {"TM Drive RPM Tar Err Ign Cor", "TMRPMEICor", HT_TM_RPM_ERROR_IGN_CORR,  0x3EC,  4,       5,     UNIT_DEGREES,   0.1f,   0.0f,    50,   true,   0,    0.0f},
    {"TM Drive RPM Timed Ign Cor",   "TMRPMTICor", HT_TM_RPM_TIMED_IGN_CORR,  0x3EC,  6,       7,     UNIT_DEGREES,   0.1f,   0.0f,    50,   true,   0,    0.0f},
    {"TM Combined Ign Correction",   "TMCombICor", HT_TM_COMBINED_IGN_CORR,   0x3ED,  0,       1,     UNIT_DEGREES,   0.1f,   0.0f,    50,   true,   0,    0.0f},
    ...
    {"Shock Travel FL Uncalibrated", "STraFLUcal", HT_SHOCK_TRAVEL_FL_UNCAL,  0x3F0,  0,       1,     UNIT_MM,        0.1f,   0.0f,    50,   false,  0,    0.0f},
    {"Shock Travel FR Uncalibrated", "STraFRUcal", HT_SHOCK_TRAVEL_FR_UNCAL,  0x3F0,  2,       3,     UNIT_MM,        0.1f,   0.0f,    50,   false,  0,    0.0f},
    {"Shock Travel RL Uncalibrated", "STraRLUcal", HT_SHOCK_TRAVEL_RL_UNCAL,  0x3F0,  4,       5,     UNIT_MM,        0.1f,   0.0f,    50,   false,  0,    0.0f},
    {"Shock Travel RR Uncalibrated", "STraRRUcal", HT_SHOCK_TRAVEL_RR_UNCAL,  0x3F0,  6,       7,     UNIT_MM,        0.1f,   0.0f,    50,   false,  0,    0.0f},
    {"Shock Travel Front Left",      "ShockTraFL", HT_SHOCK_TRAVEL_FL,        0x3F1,  0,       1,     UNIT_MM,        0.1f,   0.0f,    50,   true,   0,    0.0f},
    {"Shock Travel Front Right",     "ShockTraFR", HT_SHOCK_TRAVEL_FR,        0x3F1,  2,       3,     UNIT_MM,        0.1f,   0.0f,    50,   true,   0,    0.0f},
    {"Shock Travel Rear Left",       "ShockTraRL", HT_SHOCK_TRAVEL_RL,        0x3F1,  4,       5,     UNIT_MM,        0.1f,   0.0f,    50,   true,   0,    0.0f},
    {"Shock Travel Rear Right",      "ShockTraRR", HT_SHOCK_TRAVEL_RR,        0x3F1,  6,       7,     UNIT_MM,        0.1f,   0.0f,    50,   true,   0,    0.0f},
    {"ECU Temperature",              "ECUTemp",    HT_ECU_TEMPERATURE,        0x469,  0,       1,     UNIT_K,         0.1f,   0.0f,    5,    false,  0,    0.0f},
    ...
    {"Injector Pressure Diff",       "InjPresDif", HT_PRESSURE_DIFFERENTIAL,  0x471,  0,       1,     UNIT_KPA,       0.1f,   0.0f,    50,   true,   0,    0.0f},
    {"Accelerator Pedal Position",   "AccPedPos",  HT_ACCELERATOR_PEDAL_POS,  0x471,  2,       3,     UNIT_PERCENT,   0.1f,   0.0f,    50,   false,  0,    0.0f},
    {"Exhaust Manifold Pressure",    "ExhManPres", HT_EXHAUST_MANIFOLD_PRESS, 0x471,  4,       5,     UNIT_KPA,       0.1f,   0.0f,    50,   false,  0,    0.0f},
    ...
    {"Total Fuel Used",              "TotFuelUse", HT_TOTAL_FUEL_USED,        0x473,  0,       3,     UNIT_CC,        1.0f,   0.0f,    10,   false,  0,    0.0f},
    {"Rolling Antilag Switch State", "RollALSt",   HT_ROLLING_AL_SW_STATE,    0x473,  4,       4,     UNIT_BOOLEAN,   1.0f,   0.0f,    10,   false,  0,    0.0f},
    {"Antilag Switch State",         "ALSwSt",     HT_AL_SWITCH_STATE,        0x473,  4,       4,     UNIT_BOOLEAN,   1.0f,   0.0f,    10,   false,  0,    0.0f},
    {"Antilag Output State",         "ALOutSt",    HT_AL_OUTPUT_STATE,        0x473,  4,       4,     UNIT_BOOLEAN,   1.0f,   0.0f,    10,   false,  0,    0.0f},
    ...
    {"Aux 1 Fuel Pump Output State", "Ax1FPOutSt", HT_AUX1_FP_OUTPUT_STATE,   0x473,  4,       4,     UNIT_BOOLEAN,   1.0f,   0.0f,    10,   false,  0,    0.0f},
    {"Aux 2 Fuel Pump Output State", "Ax2FPOutSt", HT_AUX2_FP_OUTPUT_STATE,   0x473,  4,       4,     UNIT_BOOLEAN,   1.0f,   0.0f,    10,   false,  0,    0.0f},
    {"Aux 3 Fuel Pump Output State", "Ax3FPOutSt", HT_AUX3_FP_OUTPUT_STATE,   0x473,  4,       4,     UNIT_BOOLEAN,   1.0f,   0.0f,    10,   false,  0,    0.0f},
    {"Nitrous En 1 Switch State",    "N2OEn1SwSt", HT_N2O_ENABLE1_SW_STATE,   0x473,  5,       5,     UNIT_BOOLEAN,   1.0f,   0.0f,    10,   false,  0,    0.0f},
    {"Nitrous En 1 Output State",    "N2OEn1OtSt", HT_N2O_ENABLE1_OUT_STATE,  0x473,  5,       5,     UNIT_BOOLEAN,   1.0f,   0.0f,    10,   false,  0,    0.0f},
    {"Nitrous En 2 Switch State",    "N2OEn2SwSt", HT_N2O_ENABLE2_SW_STATE,   0x473,  5,       5,     UNIT_BOOLEAN,   1.0f,   0.0f,    10,   false,  0,    0.0f},
    {"Nitrous En 2 Output State",    "N2OEn2OtSt", HT_N2O_ENABLE2_OUT_STATE,  0x473,  5,       5,     UNIT_BOOLEAN,   1.0f,   0.0f,    10,   false,  0,    0.0f},
    {"Nitrous En 3 Switch State",    "N2OEn3SwSt", HT_N2O_ENABLE3_SW_STATE,   0x473,  5,       5,     UNIT_BOOLEAN,   1.0f,   0.0f,    10,   false,  0,    0.0f},
    {"Nitrous En 3 Output State",    "N2OEn3OtSt", HT_N2O_ENABLE3_OUT_STATE,  0x473,  5,       5,     UNIT_BOOLEAN,   1.0f,   0.0f,    10,   false,  0,    0.0f},
    {"Nitrous En 4 Switch State",    "N2OEn4SwSt", HT_N2O_ENABLE4_SW_STATE,   0x473,  5,       5,     UNIT_BOOLEAN,   1.0f,   0.0f,    10,   false,  0,    0.0f},
    {"Nitrous En 4 Output State",    "N2OEn4OtSt", HT_N2O_ENABLE4_OUT_STATE,  0x473,  5,       5,     UNIT_BOOLEAN,   1.0f,   0.0f,    10,   false,  0,    0.0f},
    {"Nitrous Override 1 Switch St", "N2OOv1SwSt", HT_N2O_OVR1_SW_STATE,      0x473,  6,       6,     UNIT_BOOLEAN,   1.0f,   0.0f,    10,   false,  0,    0.0f},
    {"Nitrous Override 1 Output St", "N2OOv1OtSt", HT_N2O_OVR1_OUT_STATE,     0x473,  6,       6,     UNIT_BOOLEAN,   1.0f,   0.0f,    10,   false,  0,    0.0f},
    {"Nitrous Override 2 Switch St", "N2OOv2SwSt", HT_N2O_OVR2_SW_STATE,      0x473,  6,       6,     UNIT_BOOLEAN,   1.0f,   0.0f,    10,   false,  0,    0.0f},
    {"Nitrous Override 2 Output St", "N2OOv2OtSt", HT_N2O_OVR2_OUT_STATE,     0x473,  6,       6,     UNIT_BOOLEAN,   1.0f,   0.0f,    10,   false,  0,    0.0f},
    {"Nitrous Override 3 Switch St", "N2OOv3SwSt", HT_N2O_OVR3_SW_STATE,      0x473,  6,       6,     UNIT_BOOLEAN,   1.0f,   0.0f,    10,   false,  0,    0.0f},
    {"Nitrous Override 3 Output St", "N2OOv3OtSt", HT_N2O_OVR3_OUT_STATE,     0x473,  6,       6,     UNIT_BOOLEAN,   1.0f,   0.0f,    10,   false,  0,    0.0f},
    {"Nitrous Override 4 Switch St", "N2OOv4SwSt", HT_N2O_OVR4_SW_STATE,      0x473,  6,       6,     UNIT_BOOLEAN,   1.0f,   0.0f,    10,   false,  0,    0.0f},
    {"Nitrous Override 4 Output St", "N2OOv4OtSt", HT_N2O_OVR4_OUT_STATE,     0x473,  6,       6,     UNIT_BOOLEAN,   1.0f,   0.0f,    10,   false,  0,    0.0f},
    ...
    {"Water Inj Adv Ovr Output St",  "WIAOvrOtSt", HT_WATER_INJ_OVR_OUTPUT,   0x473,  7,       7,     UNIT_BOOLEAN,   1.0f,   0.0f,    10,   false,  0,    0.0f},
    ...
    {"Brake Pressure Rear",          "BrPresRear", HT_BRAKE_PRESSURE_REAR,    0x476,  0,       1,     UNIT_KPA,       1.0f,   -101.3f, 20,   false,  0,    0.0f},
    {"Brake Pressure Front Ratio",   "BrPresFRat", HT_BRAKE_PRESSURE_F_RATIO, 0x476,  2,       3,     UNIT_PERCENT,   0.1f,   0.0f,    20,   false,  0,    0.0f},
    {"Brake Pressure Rear Ratio",    "BrPresRRat", HT_BRAKE_PRESSURE_R_RATIO, 0x476,  4,       5,     UNIT_PERCENT,   0.1f,   0.0f,    20,   false,  0,    0.0f},
    {"Brake Pressure Difference",    "BrPresDiff", HT_BRAKE_PRESSURE_DIFF,    0x476,  6,       7,     UNIT_KPA,       1.0f,   0.0f,    20,   true,   0,    0.0f},
    ...
    {"Cut Percent Function",         "CutPerFunc", HT_CUT_PERCENTAGE_FUNC,    0x477,  6,       6,     UNIT_ENUM,      1.0f,   0.0f,    10,   false,  0,    0.0f}, 
    ...
    {"Tire Sensor Battery Volt FL",  "TireBatVFL", HT_TIRE_SENSOR_BATTERY_FL, 0x6F2,  0,       1,     UNIT_VOLTS,     0.001f, 0.0f,    5,    false,  0,    0.0f}, 
    {"Tire Sensor Battery Volt FR",  "TireBatVFR", HT_TIRE_SENSOR_BATTERY_FR, 0x6F2,  2,       3,     UNIT_VOLTS,     0.001f, 0.0f,    5,    false,  0,    0.0f}, 
    {"Tire Sensor Battery Volt RL",  "TireBatVRL", HT_TIRE_SENSOR_BATTERY_RL, 0x6F2,  4,       5,     UNIT_VOLTS,     0.001f, 0.0f,    5,    false,  0,    0.0f}, 
    {"Tire Sensor Battery Volt RR",  "TireBatVRR", HT_TIRE_SENSOR_BATTERY_RR, 0x6F2,  6,       7,     UNIT_VOLTS,     0.001f, 0.0f,    5,    false,  0,    0.0f}, 
    ...
    {"Calculated Air Temperature",   "CalAirTemp", HT_CALCULATED_AIR_TEMP,    0x6F7,  4,       5,     UNIT_K,   0.1f,   0.0f,    10,   false,  0,    0.0f},
